<?php 
    ...
    $sqlstatement="SELECT * FROM users WHERE role='judge'";
...
<body id="page-top" style="max-width:100%;">
    ...
    <section class="page-section bg-light" id="participantsRegistered">
        <div class="container">
            <div class="text-center">
                <h2 class="section-heading text-uppercase">Judges</h2>
                <h3 class="section-subheading text-muted">Listed are all the Judges Registered in the event.</h3>
            </div>
            <div class="row">
    ...
    <section class="page-section bg-light" id="Register Coach" style="background-color: grey;">
        <div class="container">
            <div class="text-center">
                <h2 class="section-heading text-uppercase">Add a Judge</h2>
                <h3 class="section-subheading text-muted">Add judges that will participate in this event</h3>
            </div>
            ...
            <div class="row align-items-stretch mb-5">
                <div class="col-md-6">
                    <div class="form-group">
                        <!-- Name input-->
                        <input class="form-control" id="nameCoach" type="text" placeholder="Judge's Name*"/>
                    </div><br>
                    <div class="form-group">
                        <!-- Email address input-->
                        <input class="form-control" id="emailCoach" type="text" placeholder="Judge's Email*"/>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <input class="form-control" id="clubCoach" type="text" placeholder="Judge's Club*"/>  
                    </div><br>
                    <div class="form-group">
                        <input class="form-control" id="passwordCoach" type="text" placeholder="Judge's Password*"/>  
                    </div>
                </div>
                <div class="form-group">
                    <br>
                ...
                <script src="js/registerJudge.js"></script>
            </div>
            </form>
            <br>
        </div>
